<%@ Page Title="" Language="C#" MasterPageFile="~/UI/DashBoard.Master" AutoEventWireup="true" CodeBehind="AddNewCustomer.aspx.cs" Inherits="LogIn.UI.AddNewCustomer" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-8 col-md-offset-1">
         ...
         <fieldset>
          ...
          <!-- Form Name -->
          <legend><asp:Label runat="server" ID="pageHeaderLabel">Add New Customer</asp:Label></legend>
         <form id="form1" CssClass="form-horizontal" role="form">
          ...
          <div class="form-group">
             <div class="row">
              ...
              <label class=" col-md-3">Uoload NID:</label>
               <div class="col-md-3 ">
