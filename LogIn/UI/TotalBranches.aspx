<%@ Page Title="" Language="C#" MasterPageFile="~/UI/DashBoard.Master" AutoEventWireup="true" CodeBehind="TotalBranches.aspx.cs" Inherits="LogIn.UI.TotalBranches" %>
    ...
    <div class="container-fluid">
                         <div class="row">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12">
                                <legend class="legend">Total Branches</legend>
                                  <div class="row">
                                  ...
                                  <hr/>
                                    <asp:GridView runat="server" ID="totalBranchesGridView" AutoGenerateColumns="True" Height="155px" Width="718px">
                                        <Columns>
